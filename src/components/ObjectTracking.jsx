...
const ObjectTracking = ({ videoSrc, measurements, onUpdateMeasurements }) => {
    ...
    const handleStartDetection = () => {
        ...
        if (status !== 'Ready') {
            alert('Detector not ready. Please wait.');
            return;
        }
    ...
    const handleExportToMeasurements = () => {
        if (tracks.size === 0) {
            alert('No tracked objects to export.');
            return;
        }
        ...
        alert(`✅ Exported ${newMeasurements.length} object tracks to measurements!`);
    };
            ...
            {showHelp && (
                <div style={{
                    ...
                    <div style={{
                        ...
                        <h2 style={{ margin: '0 0 20px 0', color: '#00d2ff' }}>📦 Object Detection & Tracking - Help</h2>

                        <h3 style={{ color: '#feca57', marginTop: '20px' }}>📌 Fungsi</h3>
